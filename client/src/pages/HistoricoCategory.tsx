...
export default function HistoricoCategory() {
  ...
  if (params) {
    ...
    const solvente = paramsTrans.solvente ? decodeURIComponent(paramsTrans.solvente).charAt(0).toUpperCase() + decodeURIComponent(paramsTrans.solvente).slice(1) : "Solvente";
    category = "Transbordo";
                ...
                <div className="space-y-3 bg-card border rounded-xl p-4">
                  ...
                  {selectedRecord.nf && (
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-xs text-muted-foreground font-medium">Referência</p>
